        ...
        <div class="row">
          <div class="col-md-6">
            <p class="mb-0">
              ...
              <span><strong class="text-white"><a href="index.php">She Code Africa</a></strong></span>
            </p>
          </div>
          <div class="col-md-6">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.php"><img src="images/sca_logo.jpg" width="100"></a></h1>
          </div>
