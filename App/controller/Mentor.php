...
//insert into db
    ...
    public static function getAll() {
        ...
        $mentees = $db->select("SELECT MENTORS.*,  USERS.FNAME AS f_name, USERS.LNAME AS l_name, USERS.PICTURE AS picture, COHORTS.NAME AS cohort_name, TRACKS.NAME AS track_name FROM MENTORS JOIN USERS ON USERS.ID = MENTORS.MENTOR_ID JOIN COHORTS ON COHORTS.ID = MENTORS.COHORT_ID JOIN TRACKS ON TRACKS.ID = MENTORS.TRACK_ID ORDER BY MENTORS.MENTOR_ID DESC LIMIT 2");
        return $mentees;
    }
